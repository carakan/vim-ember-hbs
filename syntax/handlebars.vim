...
syntax match hbsArg "\v\S+\=@=" contained containedin=hbsMustache,hbsMustacheBlock,hbsPencil,hbsElseBlock
syntax match hbsOperator "\v(\S+)@<=\=" contained containedin=hbsMustache,hbsMustacheBlock,hbsPencil,hbsElseBlock
